		...
		<div class="content-line">
			<?php
				if (is_archive()) {
					...
					echo $trimmed = wp_trim_words( get_the_content(), 70, null ); ?>

					<div class="entry-footer">
						<a class="more-link" href="<?php echo the_permalink(); ?>"><?php _e( 'READ MORE', 'aniki') ?><i class="fa fa-long-arrow-right"></i></a>
					</div><!-- .entry-footer -->
